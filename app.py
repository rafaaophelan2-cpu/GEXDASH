...
with tab_drift:
    ...
    if len(full_timestamps) > 0 and len(call_drift_raw) > 0:
        ...
        # El eje de las líneas de Drift permite zoom vertical manual libre
        ...
        # El eje del precio (QQQ) auto-ajusta dinámicamente con el tiempo sin bloquear el zoom vertical de las líneas
        fig_drift.update_yaxes(fixedrange=True, autorange=True, showgrid=True, gridcolor="rgba(255,255,255,0.05)", row=1, col=1, secondary_y=True)
