...
with tab_drift:
    ...
    if len(full_timestamps) > 0 and len(call_drift_raw) > 0:
        ...
        fig_drift.update_yaxes(fixedrange=False, showgrid=True, gridcolor="rgba(255,255,255,0.05)", row=1, col=1)
        fig_drift.update_yaxes(fixedrange=False, showgrid=True, gridcolor="rgba(255,255,255,0.05)", row=1, col=1, secondary_y=True)
